...
let targetCalendar = document.getElementById('bmnt-plan-calendar')
let currentMonth = document.getElementById('bmnt-current-month')
let currentYear = document.getElementById('bmnt-current-year')
let monthPrevButton = document.getElementById('bmnt-month-prev')
let monthNextButton = document.getElementById('bmnt-month-next')
