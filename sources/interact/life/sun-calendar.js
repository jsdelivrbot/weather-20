...
let targetCalendar = document.getElementById('sun-plan-calendar')
let currentMonth = document.getElementById('sun-current-month')
let currentYear = document.getElementById('sun-current-year')
let monthPrevButton = document.getElementById('sun-month-prev')
let monthNextButton = document.getElementById('sun-month-next')
...
let calendarInstance = new Calendar(targetCalendar, function (){
	...
	for(let weekData of updatedCalendar.data){
		for(let dayData of weekData){
			...
			let BMNT = `${lightData.sunRise}`
			let EENT = `${lightData.sunSet}`
