...
export default function Sign(
	...
	if(!SchemaCheck(response, accountSchema, ['id','peerId','channelId','channelPw'], `${processType} 가입`, processId)) return
	...
	// 권한 확인
	Authorize(
		accountSchema.id, accountSchema.channelPw,
