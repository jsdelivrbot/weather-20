...
export default function Delete(
	...
	if(!SchemaCheck(response, accountSchema, ['id', 'peerId', 'channelId', 'documentId'], `${processType}삭제`, processId)) return
	...
	Authorize(
		...
		// 데이터베이스에 정보삭제를 시도합니다.
		database[databaseKey].delete(accountSchema.documentId, (isSuccess, status)=>{
