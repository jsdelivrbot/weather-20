...
export default function Write(
	...
	if(!SchemaCheck(response, accountSchema, ['id', 'peerId', 'channelId', 'documentId', 'context'], `${processType} 삭제`, processId)) return
	...
	Authorize(
		...
		// 게시글 수정 처리시작
		database[databaseKey].change(accountSchema.documentId, (data)=>{
